...
- использование ключа, при нажатии кнопки "Перевод" появиться окно для ввода ключа ![alt text](api_key.png) ввести ключ и программа его сохранит в папке программы и и создаст файл `api_key.txt`, при дальнейшем использовании ввод ключа не потребуется.
